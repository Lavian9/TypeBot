  ...
  <Stack spacing="12">
    ...
    >
      <Stack spacing={4}>
        ...
        <Link href="https://app.typebot.xyz/register">
      ...
      <Stack spacing={4}>
        ...
        <Link
          href={`https://app.typebot.xyz/register?subscribePlan=${Plan.STARTER}`}
        >
      ...
      <Stack spacing={4}>
        ...
        <Link
          href={`https://app.typebot.xyz/register?subscribePlan=${Plan.PRO}`}
        >
